...
def main() -> int:
    ...
    proxy.call_tool(
        "tap_screen",
        {
            ...
            "_intent": "navigate Pokemon GO window to fullscreen layout",
            "_expected_after": "Pokemon GO fullscreen window",
        },
    )
    after = screen_snapshot(proxy)
    if after.image:
        output = Path(__file__).resolve().parents[1] / ".pogo-data" / "pokemon-fullscreen-v43.png"
