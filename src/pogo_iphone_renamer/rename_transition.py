...
from . import device_controller as base  # noqa: E402
from .config import Settings  # noqa: E402
from .deterministic_appraisal_agent import run as run_portrait  # noqa: E402
from .rename_observation import _field_value, _mark_rename_observation  # noqa: E402
from .name_input import _backspace_current_name  # noqa: E402
from .appraisal_rows import measure_row_appraisal  # noqa: E402
from .local_ocr import ocr_mcp_screenshot, rename_dialog_visible  # noqa: E402
from .name_recognition import analyze_name_region  # noqa: E402
from .native_agent import emit  # noqa: E402
from .resilient_mcp import ResilientStreamableHTTPClient  # noqa: E402
...
base.measure_ipad14_6_appraisal = measure_row_appraisal
...
def run(mode: str, settings: Settings, ollama_url: str, model: str) -> int:
    ...
    rename_snapshot = rename_verification._open_verified_rename_dialog(proxy, snapshot, species)
...
# Imported late to avoid circular imports in the rename_verification adapter chain.
from . import verified_rename as rename_verification  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="iPad landscape verified Pokémon GO renamer")
