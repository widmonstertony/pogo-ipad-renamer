...
from .legacy_gui_navigation import ResilientNavigationApp
from .gui_native import collect_native_status


class CaptureRecoveryApp(ResilientNavigationApp):
    ...
    def _run_worker(self, write_enabled: bool) -> None:
        ...
        command = [
            ...
            "-u",
            "-m",
            "pogo_iphone_renamer.device_recovery",
            "--mode",
...
def main(argv: list[str] | None = None) -> int:
    ...
    window = tk.Tk()
    CaptureRecoveryApp(window, root)
    window.mainloop()
    return 0
