...
from .legacy_gui_deterministic import (
    DeterministicBatchApp,
    collect_deterministic_status,
)


class SafeBatchApp(DeterministicBatchApp):
    ...
    def _run_worker(self, write_enabled: bool) -> None:
        ...
        command = [
            ...
            "-u",
            "-m",
            "pogo_iphone_renamer.stale_dialog_recovery",
            "--mode",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Pokémon GO 纯 Python 横屏整理助手")
