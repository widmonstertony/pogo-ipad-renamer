...
from .legacy_gui_deterministic import collect_deterministic_status
from .legacy_gui_safety import SafeBatchApp
...
class LegacyDesktopApp(SafeBatchApp):
    ...
    def _build_ui(self) -> None:
        ...
        # 1.  Batch UI must restore the persisted value after that base setup;
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Pokémon GO 纯 Python 批量整理助手")
