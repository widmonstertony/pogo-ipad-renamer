...
from .appraisal_track import _is_gray_track
from .appraisal_rows import _select_track_rows
...
def _row_consensus_endpoint(
    ...
    *,
    ...
    # score (the earlier single-endpoint failure mode).
...
def measure_upright_appraisal(image: Image.Image) -> IVMeasurement:
...
def measure_decoded_appraisal(
    ...
    return measure_upright_appraisal(image)
