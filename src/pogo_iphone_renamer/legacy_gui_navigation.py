...
from .legacy_gui_verification import VerifiedRenameApp
from .gui_native import collect_native_status


class ResilientNavigationApp(VerifiedRenameApp):
    ...
    def _run_worker(self, write_enabled: bool) -> None:
        ...
        command = [
            ...
            "-u",
            "-m",
            "pogo_iphone_renamer.game_navigation",
            "--mode",
...
def main(argv: list[str] | None = None) -> int:
    ...
    window = tk.Tk()
    ResilientNavigationApp(window, root)
    window.mainloop()
    return 0
