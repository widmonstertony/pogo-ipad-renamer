...
from . import accessibility_names as names  # noqa: E402
...
from .name_region import exact_species_from_name_region  # noqa: E402
...
def _commit_and_verify(
    ...
    *,
    ...
    names.cancel_name_field(proxy)


rename_verification.exact_species_from_mcp_screenshot = exact_species_from_name_region
rename_verification._commit_and_verify = _commit_and_verify


def main(argv: list[str] | None = None) -> int:
    return rename_verification.main(argv)
