...
from .rename_observation import _field_value, _mark_rename_observation
...
from .rename_controls import tap_cancel, tap_ok
...
_ORIGINAL_NAVIGATE = navigation.navigate_to_appraisal
...
def run(mode: str, settings: Settings) -> int:
    ...
    with DeviceRunLock(lock_path):
        ...
        transition._commit_with_transition_verification = _commit_with_dynamic_controls
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Pure-Python locked deterministic iPad renamer"
    )
