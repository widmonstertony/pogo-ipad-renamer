...
from .legacy_gui_base import LegacyAppBase, friendly_ipad_landscape_event
from .gui_native import collect_native_status


class NameInputApp(LegacyAppBase):
    ...
    def _run_worker(self, write_enabled: bool) -> None:
        ...
        command = [
            ...
            "-u",
            "-m",
            "pogo_iphone_renamer.name_input",
            "--mode",
