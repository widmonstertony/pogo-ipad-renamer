...
from .legacy_gui_recovery import CaptureRecoveryApp
...
class DeterministicBatchApp(CaptureRecoveryApp):
    ...
    def _run_worker(self, write_enabled: bool) -> None:
        ...
        command = [
            ...
            "-u",
            "-m",
            "pogo_iphone_renamer.rename_dialog",
            "--mode",
...
def main(argv: list[str] | None = None) -> int:
    ...
    window = tk.Tk()
    DeterministicBatchApp(window, root)
    window.mainloop()
    return 0
