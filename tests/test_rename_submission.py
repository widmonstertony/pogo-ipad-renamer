...
class BatchVerifiedCommitTests(unittest.TestCase):
    ...
    def test_cancel_wait_accepts_current_pixel_detail_despite_stale_ax(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.rename_submission.base.local_page_state",
            return_value="DETAIL",
        ) as local_state, patch(
            "pogo_iphone_renamer.rename_submission.base._validate_expected"
        ) as validate:
    ...
    def test_task_switcher_waits_without_touching_rename_dialog(self) -> None:
        ...
        with patch.dict(
            ...
            "pogo_iphone_renamer.rename_submission.base._next_snapshot",
            side_effect=clear_overlay,
        ) as next_snapshot, patch(
            "pogo_iphone_renamer.rename_submission.emit"
        ) as emit:
    ...
    def test_keyboard_dismiss_waits_through_one_empty_ocr_frame(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.rename_submission.ocr_mcp_screenshot",
            return_value=(),
        ), patch(
            "pogo_iphone_renamer.rename_submission.rename_dialog_visible",
            side_effect=[False, True],
        ), patch(
            "pogo_iphone_renamer.rename_submission.exact_accessibility_tap_point",
            return_value=None,
        ), patch(
            "pogo_iphone_renamer.rename_submission.emit"
        ):
    ...
    def test_accessibility_evidence_uses_accessibility_for_first_submit(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.rename_submission._tap_accessibility_ok",
            return_value=True,
        ) as accessibility_ok, patch(
            "pogo_iphone_renamer.rename_submission.tap_ok"
        ) as ocr_ok, patch(
            "pogo_iphone_renamer.rename_submission.base._next_snapshot",
            return_value=detail,
        ) as read, patch(
            ...
            "pogo_iphone_renamer.rename_submission.navigation.robust_page_state",
            return_value="DETAIL",
        ):
    ...
    def test_accessibility_ok_retry_uses_exact_returned_point(self) -> None:
        ...
        ), patch("pogo_iphone_renamer.rename_submission.emit"):
    ...
    def test_slow_submit_waits_read_only_before_retrying_ok(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.rename_submission._focus_ocr_default_name_field"
        ), patch(
            "pogo_iphone_renamer.rename_submission._dialog_contains_exact_text",
            return_value=False,
        ), patch(
            "pogo_iphone_renamer.rename_submission._backspace_current_name",
            return_value=4,
        ), patch(
            "pogo_iphone_renamer.rename_submission._mark_rename_observation"
        ), patch(
            "pogo_iphone_renamer.rename_submission._verified_entered_value",
            return_value=nickname,
        ), patch(
            "pogo_iphone_renamer.rename_submission.dismiss_active_keyboard",
            return_value=False,
        ), patch(
            "pogo_iphone_renamer.rename_submission.base._next_snapshot",
    ...
    def test_unchanged_dialog_reverifies_field_then_retries(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.rename_submission._verified_entered_value_with_read_only_retry",
            return_value=nickname,
        ) as verify, patch(
            "pogo_iphone_renamer.rename_submission._tap_accessibility_ok",
            return_value=False,
    ...
    def test_retry_ok_disappearance_accepts_proven_detail_without_another_tap(self) -> None:
        ...
        ) as ok, patch("pogo_iphone_renamer.rename_submission.emit"):
            returned = _submit_with_one_verified_retry(proxy, nickname=nickname)
    ...
    def test_empty_accessibility_field_is_cancelled_without_submit(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.rename_submission.tap_cancel"
        ) as cancel, patch(
            "pogo_iphone_renamer.rename_submission.tap_ok"
        ) as ok, patch(
            "pogo_iphone_renamer.rename_submission.base._validate_expected"
    ...
    def test_unchanged_default_after_input_uses_one_type_text_fallback(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.rename_submission._submit_with_one_verified_retry",
            return_value=detail,
        ), patch(
            "pogo_iphone_renamer.rename_submission._finalize_verified_commit"
        ), patch("pogo_iphone_renamer.rename_submission.emit"):
    ...
    def test_default_still_visible_after_clear_never_sends_text(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.rename_submission._cancel_unverified_input",
            side_effect=cancelled,
        ) as cancel, patch("pogo_iphone_renamer.rename_submission.emit"):
    ...
    def test_missing_cancel_control_recovers_from_a_verified_detail_without_retrying_a_tap(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.rename_submission._tap_accessibility_cancel",
            return_value=False,
        ), patch(
            "pogo_iphone_renamer.rename_submission.base._next_snapshot",
            side_effect=[dialog, detail],
    ...
    def test_stage_manager_cancel_uses_calibrated_anchor_not_portrait_ax_point(
        ...
        with patch(
            "pogo_iphone_renamer.rename_submission.base._tap"
        ) as tap, patch(
            "pogo_iphone_renamer.rename_submission.exact_accessibility_tap_point"
        ) as point, patch(
            "pogo_iphone_renamer.rename_submission.emit"
