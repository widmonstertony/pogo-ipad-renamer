...
from pogo_iphone_renamer.batch_navigation import (
    DetailFingerprint,
...
class DetailFingerprintTests(unittest.TestCase):
    def test_name_free_fingerprint_keeps_numeric_identity_for_confirmed_nickname(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.batch_navigation.measure_ipad14_6_appraisal",
            side_effect=ValueError("plain detail"),
        ), patch(
            "pogo_iphone_renamer.batch_navigation.analyze_name_region",
            return_value=unreadable_name,
        ), patch(
            "pogo_iphone_renamer.batch_navigation.ocr_mcp_screenshot",
    ...
    def test_swipe_helper_always_issues_the_write_call(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.batch_navigation.base.current_stage_geometry",
            return_value="geometry",
        ), patch(
            "pogo_iphone_renamer.batch_navigation.base.upright_ratio_to_touch",
    ...
    def test_portrait_window_keeps_visual_horizontal_swipe_in_window_coordinates(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.batch_navigation.base.ORIENTATION",
    ...
    def test_four_verified_unchanged_swipes_prove_storage_end(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.batch_navigation._stable_baseline",
            return_value=(detail, fingerprint),
        ), patch(
            "pogo_iphone_renamer.batch_navigation._swipe_next_once"
        ) as swipe, patch(
            "pogo_iphone_renamer.batch_navigation._observe_after_swipe",
    ...
    def test_verified_short_nickname_skips_name_dependent_baseline(self) -> None:
        ...
        ), patch("pogo_iphone_renamer.batch_navigation.base.emit") as emit:
    ...
    def test_preverified_named_detail_skips_redundant_baseline_ocr_wait(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_navigation._observe_after_swipe",
            return_value=(next_detail, after, True, (next_detail,) * 3),
        ), patch("pogo_iphone_renamer.batch_navigation.base.emit"):
            returned = swipe_to_verified_next(object(), detail, before=before)
    ...
    def test_persistent_mode_waits_read_only_for_post_swipe_identity(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_navigation._wait_for_post_swipe_identity",
            return_value=(next_detail, after, True, (next_detail,) * 3),
        ) as wait:
            returned = swipe_to_verified_next(object(), detail, before=before)
    ...
    def test_persistent_post_swipe_wait_recovers_after_ocr_gap(self) -> None:
        ...
        with patch.dict(
            ...
            "pogo_iphone_renamer.batch_navigation.base._next_snapshot",
            side_effect=[unreadable, recovered],
        ) as next_snapshot, patch(
            "pogo_iphone_renamer.batch_navigation.detail_fingerprint",
            side_effect=[PolicyViolation("OCR 暂不可读"), before],
        ), patch(
            "pogo_iphone_renamer.batch_navigation._snapshot_digest",
    ...
    def test_persistent_detail_fingerprint_wait_recovers_after_ocr_gap(self) -> None:
        ...
        with patch.dict(
            ...
            "pogo_iphone_renamer.batch_navigation.base.emit"
        ) as emit:
    ...
    def test_post_swipe_inventory_is_reported_for_automatic_recovery(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_navigation.base.local_page_state",
            return_value="INVENTORY",
        ):
    ...
    def test_stale_inventory_accessibility_cannot_override_detail_pixels(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_navigation._looks_like_detail_visual",
            return_value=True,
        ):
