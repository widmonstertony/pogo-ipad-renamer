...
from pogo_iphone_renamer import name_recognition
...
class NameRegionClassificationTests(unittest.TestCase):
    def test_name_crop_is_limited_to_the_title_row(self) -> None:
        self.assertEqual(name_recognition.NAME_ROW_TOP, 0.44)
        self.assertEqual(name_recognition.NAME_ROW_BOTTOM, 0.57)
    ...
    def classify(self, lines):
        with (
            ...
            patch.object(name_recognition, "ocr_image", return_value=tuple(lines)),
        ):
            return name_recognition.analyze_name_region("unused", "unused")
    ...
    def test_occluded_title_row_uses_the_shifted_fallback_crop(self) -> None:
        ...
        with (
            ...
            result = name_recognition.analyze_name_region("unused", "unused")
    ...
    def test_evolved_shortened_name_with_merged_digits_is_preserved(self) -> None:
        ...
        for bounds, suffix, accepted in (
            ...
            with self.subTest(bounds=bounds, suffix=suffix), patch.object(
                name_recognition, "rotate_mcp_image_upright", return_value=Image.new("RGB", (1024, 1366))
            ), patch.object(name_recognition, "ocr_image", side_effect=(crop, (), (
