...
from pogo_iphone_renamer.appraisal_cv import measure_upright_appraisal
...
class AppraisalCVTests(unittest.TestCase):
    ...
    def test_sparse_far_colour_cannot_fool_endpoint_decoder(self) -> None:
        ...
        with self.assertRaises(ValueError):
            measure_upright_appraisal(image)
