...
class BatchUnreadableAppraisalTests(unittest.TestCase):
    def test_unreadable_title_uses_untouched_field_for_default_name(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.batch_agent.base._validate_expected"
        ), patch(
            "pogo_iphone_renamer.batch_agent.base.local_page_state",
            side_effect=[
                "DETAIL",
                "RENAME_DIALOG",
                "RENAME_DIALOG",
            ...
            "pogo_iphone_renamer.batch_agent._static_pencil_coordinates",
            return_value=(1.0, 2.0),
        ), patch(
            "pogo_iphone_renamer.batch_agent._tap_dynamic_pencil_at"
        ), patch(
            "pogo_iphone_renamer.batch_agent._wait_for_dialog_or_detail_after_pencil",
            return_value=dialog,
        ), patch(
            "pogo_iphone_renamer.batch_agent.base._next_snapshot",
            side_effect=[dialog, dialog, dialog],
        ), patch(
            "pogo_iphone_renamer.batch_agent.exact_name_field",
            side_effect=["巨金怪", "巨金怪", "巨金怪"],
        ), patch(
            "pogo_iphone_renamer.batch_agent._cancel_unverified_input",
            side_effect=RenameFieldVerificationUnavailable(restored, "巨金怪"),
        ), patch(
            "pogo_iphone_renamer.batch_agent.traditional_chinese_species",
            return_value=frozenset({"巨金怪"}),
        ), patch("pogo_iphone_renamer.batch_agent.emit"):
    ...
    def test_egg_tab_requires_visual_change_then_adopts_verified_fallback_mapping(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.batch_agent.locate_exact_text_from_mcp",
            return_value=located,
        ), patch(
            "pogo_iphone_renamer.batch_agent.base.current_stage_geometry",
            return_value=None,
        ), patch(
            "pogo_iphone_renamer.batch_agent.base.upright_ratio_to_touch",
            return_value=(683.0, 133.0),
        ), patch(
            "pogo_iphone_renamer.batch_agent.base.portrait_window_ax_rotated_touch",
            return_value=(683.0, 133.0),
        ), patch(
            "pogo_iphone_renamer.batch_agent.base.portrait_window_visible_touch",
            return_value=(520.0, 133.0),
        ), patch(
            "pogo_iphone_renamer.batch_agent.base.portrait_window_legacy_rotated_touch",
            return_value=(978.0, 520.0),
        ), patch(
            "pogo_iphone_renamer.batch_agent.base._next_snapshot",
            side_effect=[egg, egg, egg, cards],
        ), patch(
            "pogo_iphone_renamer.batch_agent.navigation.robust_page_state",
            return_value="INVENTORY",
        ), patch(
            "pogo_iphone_renamer.batch_agent._egg_overview_visible",
    ...
    def test_missing_fresh_detail_identity_retries_same_card_without_counting_it(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.batch_agent._ensure_plain_detail",
            return_value=detail,
        ), patch(
            "pogo_iphone_renamer.batch_agent._confirm_fresh_detail_identity",
            return_value=None,
        ), patch(
            "pogo_iphone_renamer.batch_agent.emit",
        ) as emit:
    ...
    def test_process_one_recovers_proven_appraisal_before_identity_reads(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_agent._restore_direct_detail_after_interrupted_appraisal",
            return_value=detail,
        ) as restore, patch(
            "pogo_iphone_renamer.batch_agent._ensure_plain_detail",
            return_value=detail,
        ), patch(
            "pogo_iphone_renamer.batch_agent._scroll_verified_detail_to_title",
            return_value=detail,
        ), patch(
            "pogo_iphone_renamer.batch_agent._confirm_fresh_detail_identity",
            return_value=None,
    ...
    def test_inventory_fallback_requires_two_fresh_target_cp_reads(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.batch_agent._visible_inventory_cards",
            return_value=[
            ...
            "pogo_iphone_renamer.batch_agent.detail_fingerprint",
    ...
    def test_unlock_recovery_waits_for_task_switcher_without_selecting_a_card(self) -> None:
        ...
        settings = SimpleNamespace(journal_path=Path("/definitely/not/a/journal"))
        with patch(
            "pogo_iphone_renamer.batch_agent._wait_for_visible_game_surface_after_task_switcher",
            return_value=detail,
        ) as wait, patch(
            "pogo_iphone_renamer.batch_agent.base.local_page_state",
            return_value="DETAIL",
        ), patch("pogo_iphone_renamer.batch_agent._require_current_detail",
            return_value=detail,
        ), patch("pogo_iphone_renamer.batch_agent.emit"):
    ...
    def test_stale_rename_recovery_waits_for_task_switcher_before_reading_field(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_agent.base.local_page_state"
        ) as state, patch("pogo_iphone_renamer.batch_agent.emit"):
    ...
    def test_direct_geometry_waits_read_only_after_stage_manager_redraw(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.batch_agent.base._ensure_stage_geometry_for_state",
            side_effect=[
    ...
    def test_visual_navigation_fingerprint_uses_image_digest_when_no_capture_id(
        ...
        with patch(
            "pogo_iphone_renamer.batch_agent._snapshot_digest",
    ...
    def test_resume_commits_only_a_live_field_matching_journal_target(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                ...
                "pogo_iphone_renamer.batch_agent._verified_entered_value",
                return_value="奈克洛❿❿⓫⁶⁹",
            ), patch(
                "pogo_iphone_renamer.batch_agent._dialog_evidence_after_keyboard_dismiss",
                return_value=(Snapshot("rename", "dialog"), False),
            ), patch(
                "pogo_iphone_renamer.batch_agent._submit_with_one_verified_retry",
                return_value=detail,
            ) as submit, patch(
                "pogo_iphone_renamer.batch_agent.emit"
            ):
    ...
    def test_default_unsubmitted_dialog_is_cancelled_and_returns_detail(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_agent._last_unsubmitted_journal_nickname",
            return_value=None,
        ), patch(
            "pogo_iphone_renamer.batch_agent._proven_default_name_in_rename_dialog",
            return_value="涼脊龍",
        ), patch(
            "pogo_iphone_renamer.batch_agent._cancel_unverified_input",
            side_effect=cancelled,
    ...
    def test_journalled_nondefault_dialog_recovers_when_keyboard_hides_ax_field(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_agent._journalled_nondefault_rename_can_resume_without_ax",
            return_value=True,
        ), patch(
            "pogo_iphone_renamer.batch_agent._dialog_evidence_after_keyboard_dismiss",
            return_value=(Snapshot("rename", "dialog"), False),
    ...
    def test_default_dialog_proof_requires_name_inside_input_field(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.batch_agent.ocr_mcp_screenshot",
            return_value=(line,),
        ), patch(
            "pogo_iphone_renamer.batch_agent.rename_dialog_visible",
            return_value=True,
        ), patch(
            "pogo_iphone_renamer.batch_agent.exact_species_from_lines",
    ...
    def test_task_switcher_waits_for_existing_direct_detail(self) -> None:
        ...
        with patch.dict(
            ...
            "pogo_iphone_renamer.batch_agent._require_current_detail",
    ...
    def test_task_switcher_wait_reports_safe_wait_heartbeat(self) -> None:
        ...
        with patch.dict(
            ...
            "pogo_iphone_renamer.batch_agent.time.monotonic",
    ...
    def test_task_switcher_tolerates_one_unreadable_overlay_frame(self) -> None:
        ...
        with patch.dict(
            ...
            "pogo_iphone_renamer.batch_agent._has_ipad_task_switcher_overlay",
    ...
    def test_partial_appraisal_title_does_not_skip_proven_default(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_agent._navigate_with_complete_stale_recovery",
            return_value=(appraisal, measurement),
        ), patch(
            "pogo_iphone_renamer.batch_agent._confirm_low_confidence_measurement",
            return_value=(appraisal, measurement),
        ), patch(
            "pogo_iphone_renamer.batch_agent.analyze_name_region",
            return_value=partial_appraisal_name,
        ), patch(
            "pogo_iphone_renamer.batch_agent._close_appraisal",
    ...
    def test_empty_appraisal_title_on_direct_route_keeps_proven_default(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.batch_agent._wait_for_verified_next_detail",
            return_value=before,
        ), patch(
            "pogo_iphone_renamer.batch_agent._confirm_fresh_detail_identity",
            return_value=(before, detail_name),
        ), patch(
            "pogo_iphone_renamer.batch_agent._navigate_from_current_detail_only",
            return_value=(appraisal, measurement),
        ), patch(
            "pogo_iphone_renamer.batch_agent._confirm_low_confidence_measurement",
            return_value=(appraisal, measurement),
    ...
    def test_direct_resume_closes_only_a_proven_appraisal_overlay(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_agent._wait_for_direct_stage_geometry",
            return_value=appraisal,
        ), patch(
            "pogo_iphone_renamer.batch_agent._close_appraisal",
            return_value=detail,
    ...
    def test_direct_resume_advances_a_proven_appraisal_dialogue_once(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_agent._navigate_with_read_only_measurement_retry",
    ...
    def test_detail_capture_wait_never_permits_game_restart(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.batch_agent.wait_for_capture_channel",
    ...
    def test_current_detail_navigation_uses_direct_reader_not_legacy_adapter(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_agent.navigation.navigate_to_appraisal"
        ), patch(
            "pogo_iphone_renamer.batch_agent.base._tap"
        ) as tap:
    ...
    def test_current_detail_navigation_blocks_frozen_base_inventory_tap(self) -> None:
        ...
        def invoke_frozen_base_navigator(proxy, snapshot):
            # the appraisal retry module keeps an import-time reference to the original base
    ...
    def test_successful_commit_reuses_its_verified_detail_snapshot(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_agent.open_dynamic_rename_from_detail"
        ), patch(
            "pogo_iphone_renamer.batch_agent._commit_after_dismissing_keyboard",
            return_value=committed_detail,
        ) as commit, patch(
            "pogo_iphone_renamer.batch_agent.screen_snapshot"
        ) as screenshot, patch(
            "pogo_iphone_renamer.batch_agent.base._validate_expected"
        ) as validate, patch(
            "pogo_iphone_renamer.batch_agent.emit"
    ...
    def test_detail_entry_uses_resilient_navigation_until_detail(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_agent.navigation._transition",
    ...
    def test_close_appraisal_recovers_black_capture_before_validation(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_agent.navigation.snapshot_is_black",
            return_value=True,
        ), patch(
            "pogo_iphone_renamer.batch_agent.wait_for_capture_channel",
            return_value=detail,
    ...
    def test_close_appraisal_does_not_leak_raw_measurement_error(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_agent.base.measure_ipad14_6_appraisal",
    ...
    def test_pause_waits_without_phone_io_then_refreshes_same_detail(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            with patch(
                "pogo_iphone_renamer.batch_agent.time.sleep",
                ...
                "pogo_iphone_renamer.batch_agent._emit_progress"
            ) as progress, patch(
                "pogo_iphone_renamer.batch_agent.emit"
            ):
    ...
    def test_unverified_visible_dialog_resumes_with_proxy_run_settings(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.batch_agent._resume_verified_unsubmitted_rename",
            side_effect=resume,
        ), patch(
            "pogo_iphone_renamer.batch_agent.emit"
        ):
