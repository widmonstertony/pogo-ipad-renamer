...
class StableFrameRetryTests(unittest.TestCase):
    def test_retries_reads_without_repeating_navigation(self) -> None:
        ...
        with patch(
            "pogo_iphone_renamer.appraisal_retry._BASE_ORIGINAL_NAVIGATE",
            side_effect=ValueError("transition"),
        ), patch(
            "pogo_iphone_renamer.appraisal_retry.base._next_snapshot",
            return_value=stable,
        ) as read, patch(
            "pogo_iphone_renamer.appraisal_retry.base.measure_ipad14_6_appraisal",
            return_value=measurement,
        ), patch(
            "pogo_iphone_renamer.appraisal_retry.navigation.snapshot_is_black",
            return_value=False,
        ):
    ...
    def test_stable_dialogue_is_advanced_exactly_once(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.appraisal_retry.base._tap"
        ) as tap, patch(
            "pogo_iphone_renamer.appraisal_retry.navigation.snapshot_is_black",
            return_value=False,
        ):
    ...
    def test_black_retry_recovers_capture_before_pixel_measurement(self) -> None:
        ...
        with patch(
            ...
            "pogo_iphone_renamer.appraisal_retry.wait_for_capture_channel",
            return_value=stable,
        ) as recover, patch(
            "pogo_iphone_renamer.appraisal_retry.base.measure_ipad14_6_appraisal",
            return_value=measurement,
