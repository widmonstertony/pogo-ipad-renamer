...
from pogo_iphone_renamer.legacy_gui_base import friendly_ipad_landscape_event
from pogo_iphone_renamer.legacy_gui import LegacyDesktopApp


class IPadLandscapeGuiLogTests(unittest.TestCase):
    def test_accessible_unlimited_menu_reuses_guarded_start(self) -> None:
        app = object.__new__(LegacyDesktopApp)
